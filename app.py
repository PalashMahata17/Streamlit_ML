...
if st.button("✨ Predict Wastage", type="primary"):
    if quantity_food > 0:
        ...
        input_data = {
            ...
            "waste_ratio": [0],  # Placeholder, will be calculated by the model pipeline
        ...
        # Make prediction
        predicted_wastage = model.predict(input_df)

        # Display the prediction
        st.success(f"Estimated Food Wastage Amount: {predicted_wastage[0]:.2f} kg")
    else:
        st.warning("Quantity of Food must be greater than 0.")
